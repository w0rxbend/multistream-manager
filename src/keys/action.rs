...
pub enum Action {
    ...
    ChatCycleLayout,
    ChatCycleBadges,
    ChatToggleEmoteHighlight,
    ChatToggleFullUsername,
    ChatToggleTimestamps,
    StreamNextProfile,
    ConfigNextSection,
...
impl Action {
    ...
    pub const ALL: &'static [Action] = &[
        ...
        Action::ChatClose,
        Action::ChatMarker,
        Action::ChatCycleLayout,
        Action::ChatCycleBadges,
        Action::ChatToggleEmoteHighlight,
        Action::ChatToggleFullUsername,
        Action::ChatToggleTimestamps,
        Action::StreamNextProfile,
        Action::ConfigNextSection,
        Action::ConfigPreviousSection,
        Action::ConfigSwapPane,
        Action::ConfigActivate,
        Action::ConfigAddAccount,
        Action::ConfigForgetAccount,
        ...
        Action::ObsVolumeUpFine,
        Action::ObsVolumeDownFine,
    ...
    pub fn name(self) -> &'static str {
        match self {
            ...
            Action::ChatMarker => "chat.marker",
            Action::ChatCycleLayout => "chat.layout",
            Action::ChatCycleBadges => "chat.badges",
            Action::ChatToggleEmoteHighlight => "chat.emote_highlight",
            Action::ChatToggleFullUsername => "chat.full_username",
            Action::ChatToggleTimestamps => "chat.timestamps",
            Action::StreamNextProfile => "stream.next_profile",
            ...
            Action::ConfigForgetAccount => "config.forget_account",
            ...
            Action::ObsSaveReplay => "obs.save_replay",
            Action::ObsVolumeUpFine => "obs.volume_up_fine",
            Action::ObsVolumeDownFine => "obs.volume_down_fine",
    ...
    pub fn describe(self) -> &'static str {
        match self {
            ...
            Action::ChatMarker => "Mark this moment in the VOD",
            Action::ChatCycleLayout => "Cycle the message layout",
            Action::ChatCycleBadges => "Cycle how badges are drawn",
            Action::ChatToggleEmoteHighlight => "Highlight emotes and emoji",
            Action::ChatToggleFullUsername => "Show the login beside the display name",
            Action::ChatToggleTimestamps => "Show message timestamps",
            Action::StreamNextProfile => "Switch to the next stream profile",
            ...
            Action::ConfigForgetAccount => "Forget an extra chat account",
            ...
            Action::ObsSaveReplay => "Save the replay buffer",
            Action::ObsVolumeUpFine => "Volume up a little",
            Action::ObsVolumeDownFine => "Volume down a little",
